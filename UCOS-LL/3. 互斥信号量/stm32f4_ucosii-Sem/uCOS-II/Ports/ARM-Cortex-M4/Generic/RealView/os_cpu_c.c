...
{
//    INT32U  prio;
//    OS_CPU_CM4_NVIC_ST_RELOAD = cnts - 1u;   /* Set SysTick handler prio.   systick->load                           */
//    prio  = OS_CPU_CM4_NVIC_SHPRI3;
//    prio &= DEF_BIT_FIELD(24, 0);
//    prio |= DEF_BIT_MASK(OS_CPU_CFG_SYSTICK_PRIO, 24);
//    OS_CPU_CM4_NVIC_SHPRI3 = prio;            
//   	/* Enable timer.                                          */
//    OS_CPU_CM4_NVIC_ST_CTRL |= 1<<2 | //选择168M时钟
//                               1<<0;  //使能计数器                                                        /* Enable timer interrupt.                                */
//    OS_CPU_CM4_NVIC_ST_CTRL |= 1<<1;  //使能系统滴答中断
