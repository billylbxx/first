...
* 形    参 : buffer：数据存储区，read_address：开始写入的地址(24bit)，num_data：要写入的字节数(最大256)
* 返 回 值 : 无
...
* 返 回 值 : 无
* 备    注 : w25q64总共有8M字节，每页256字节，4K字节1个扇区Sectors，64K字节一个块区(Blocks)
*********************************************************************************************************/ 
...
void W25QXX_Init(void)
{
	...
	GPIO_InitStruct.GPIO_Pin   = GPIO_Pin_7;		//初始化引脚
