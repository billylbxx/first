...
u16 RTC_BKP=0x8768;  //随便改变这个值可以重新设置时间
u8 rtc_Init(void)
{
	u16 ret=0x1FFF;
  ...
  RTC_Set_Time(22,59,40,RTC_H12_AM);		
	RTC_Set_Date(7,22,9,25);
...
void RTC_Alarm_IRQHandler(void)
{
	...
	{
		printf("闹钟A\r\n");
		LCD_FLASH_SHOW_CHINESE_STR(0,0,"闹钟A响了",LCD_BLACK,LCD_WHITE,32);
		while(1)
		{
				LED1=~LED1;
				Delay_ms(100);
		if(GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0))
		{
			...
			if(GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0))
			{
				...
				LED1=1;
				printf("按键1按下\r\n");
				LCD_FLASH_SHOW_CHINESE_STR(0,0,"闹钟A关闭",LCD_BLACK,LCD_WHITE,32);
				break;
			}	
		}
	}
	...
	{
		printf("闹钟B\r\n");
		LCD_FLASH_SHOW_CHINESE_STR(0,32,"闹钟B响了",LCD_BLACK,LCD_WHITE,32);
		while(1)
		{
				LED2=~LED2;
				Delay_ms(100);
		if(!GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_13))
		{
			...
			if(!GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_13))
			{
				...
				LED2=1;
				printf("按键2按下\r\n");
				LCD_FLASH_SHOW_CHINESE_STR(0,32,"闹钟B关闭",LCD_BLACK,LCD_WHITE,32);
				break;
			}	
		}
